...
go_gc_duration_seconds{quantile="0.25"} 3.9748e-05
go_gc_duration_seconds{quantile="0.5"} 5.4283e-05
go_gc_duration_seconds{quantile="0.75"} 0.000107695
go_gc_duration_seconds{quantile="1"} 0.000173549
go_gc_duration_seconds_sum 0.00075013
...
go_memstats_alloc_bytes 1.5541824e+07
# HELP go_memstats_alloc_bytes_total Total number of bytes allocated, even if freed.
# TYPE go_memstats_alloc_bytes_total counter
go_memstats_alloc_bytes_total 6.1699576e+07
# HELP go_memstats_buck_hash_sys_bytes Number of bytes used by the profiling bucket hash table.
# TYPE go_memstats_buck_hash_sys_bytes gauge
go_memstats_buck_hash_sys_bytes 1.459633e+06
# HELP go_memstats_frees_total Total number of frees.
# TYPE go_memstats_frees_total counter
go_memstats_frees_total 193051
# HELP go_memstats_gc_cpu_fraction The fraction of this program's available CPU time used by the GC since the program started.
# TYPE go_memstats_gc_cpu_fraction gauge
go_memstats_gc_cpu_fraction 0.0002930809763250982
# HELP go_memstats_gc_sys_bytes Number of bytes used for garbage collection system metadata.
# TYPE go_memstats_gc_sys_bytes gauge
go_memstats_gc_sys_bytes 5.748064e+06
# HELP go_memstats_heap_alloc_bytes Number of heap bytes allocated and still in use.
# TYPE go_memstats_heap_alloc_bytes gauge
go_memstats_heap_alloc_bytes 1.5541824e+07
# HELP go_memstats_heap_idle_bytes Number of heap bytes waiting to be used.
# TYPE go_memstats_heap_idle_bytes gauge
go_memstats_heap_idle_bytes 4.7685632e+07
# HELP go_memstats_heap_inuse_bytes Number of heap bytes that are in use.
# TYPE go_memstats_heap_inuse_bytes gauge
go_memstats_heap_inuse_bytes 1.8898944e+07
# HELP go_memstats_heap_objects Number of allocated objects.
# TYPE go_memstats_heap_objects gauge
go_memstats_heap_objects 81092
# HELP go_memstats_heap_released_bytes Number of heap bytes released to OS.
# TYPE go_memstats_heap_released_bytes gauge
go_memstats_heap_released_bytes 4.4965888e+07
# HELP go_memstats_heap_sys_bytes Number of heap bytes obtained from system.
# TYPE go_memstats_heap_sys_bytes gauge
go_memstats_heap_sys_bytes 6.6584576e+07
# HELP go_memstats_last_gc_time_seconds Number of seconds since 1970 of last garbage collection.
# TYPE go_memstats_last_gc_time_seconds gauge
go_memstats_last_gc_time_seconds 1.612091232612422e+09
# HELP go_memstats_lookups_total Total number of pointer lookups.
# TYPE go_memstats_lookups_total counter
go_memstats_lookups_total 0
# HELP go_memstats_mallocs_total Total number of mallocs.
# TYPE go_memstats_mallocs_total counter
go_memstats_mallocs_total 274143
...
go_memstats_mspan_inuse_bytes 184144
# HELP go_memstats_mspan_sys_bytes Number of bytes used for mspan structures obtained from system.
# TYPE go_memstats_mspan_sys_bytes gauge
go_memstats_mspan_sys_bytes 311296
# HELP go_memstats_next_gc_bytes Number of heap bytes when next garbage collection will take place.
# TYPE go_memstats_next_gc_bytes gauge
go_memstats_next_gc_bytes 3.0386176e+07
# HELP go_memstats_other_sys_bytes Number of bytes used for other system allocations.
# TYPE go_memstats_other_sys_bytes gauge
go_memstats_other_sys_bytes 411887
...
net_conntrack_listener_conn_accepted_total{listener_name="http"} 4
...
net_conntrack_listener_conn_closed_total{listener_name="http"} 2
...
process_resident_memory_bytes 8.4389888e+07
# HELP process_start_time_seconds Start time of the process since unix epoch in seconds.
# TYPE process_start_time_seconds gauge
process_start_time_seconds 1.61209086042e+09
# HELP process_virtual_memory_bytes Virtual memory size in bytes.
# TYPE process_virtual_memory_bytes gauge
process_virtual_memory_bytes 9.30668544e+08
...
prometheus_build_info{branch="",goversion="go1.15.6",revision="",version=""} 1
...
prometheus_config_last_reload_success_timestamp_seconds 1.6120908716551847e+09
...
prometheus_http_request_duration_seconds_bucket{handler="/classic/status",le="0.1"} 0
prometheus_http_request_duration_seconds_bucket{handler="/classic/status",le="0.2"} 0
prometheus_http_request_duration_seconds_bucket{handler="/classic/status",le="0.4"} 0
prometheus_http_request_duration_seconds_bucket{handler="/classic/status",le="1"} 0
prometheus_http_request_duration_seconds_bucket{handler="/classic/status",le="3"} 1
prometheus_http_request_duration_seconds_bucket{handler="/classic/status",le="8"} 1
prometheus_http_request_duration_seconds_bucket{handler="/classic/status",le="20"} 1
prometheus_http_request_duration_seconds_bucket{handler="/classic/status",le="60"} 1
prometheus_http_request_duration_seconds_bucket{handler="/classic/status",le="120"} 1
prometheus_http_request_duration_seconds_bucket{handler="/classic/status",le="+Inf"} 1
prometheus_http_request_duration_seconds_sum{handler="/classic/status"} 2.218383342
prometheus_http_request_duration_seconds_count{handler="/classic/status"} 1
prometheus_http_request_duration_seconds_bucket{handler="/metrics",le="0.1"} 25
prometheus_http_request_duration_seconds_bucket{handler="/metrics",le="0.2"} 25
prometheus_http_request_duration_seconds_bucket{handler="/metrics",le="0.4"} 25
prometheus_http_request_duration_seconds_bucket{handler="/metrics",le="1"} 25
prometheus_http_request_duration_seconds_bucket{handler="/metrics",le="3"} 25
prometheus_http_request_duration_seconds_bucket{handler="/metrics",le="8"} 25
prometheus_http_request_duration_seconds_bucket{handler="/metrics",le="20"} 25
prometheus_http_request_duration_seconds_bucket{handler="/metrics",le="60"} 25
prometheus_http_request_duration_seconds_bucket{handler="/metrics",le="120"} 25
prometheus_http_request_duration_seconds_bucket{handler="/metrics",le="+Inf"} 25
prometheus_http_request_duration_seconds_sum{handler="/metrics"} 0.10668813599999998
prometheus_http_request_duration_seconds_count{handler="/metrics"} 25
# HELP prometheus_http_requests_total Counter of HTTP requests.
# TYPE prometheus_http_requests_total counter
prometheus_http_requests_total{code="200",handler="/classic/status"} 1
prometheus_http_requests_total{code="200",handler="/metrics"} 25
# HELP prometheus_http_response_size_bytes Histogram of response size for HTTP requests.
# TYPE prometheus_http_response_size_bytes histogram
prometheus_http_response_size_bytes_bucket{handler="/classic/status",le="100"} 0
prometheus_http_response_size_bytes_bucket{handler="/classic/status",le="1000"} 0
prometheus_http_response_size_bytes_bucket{handler="/classic/status",le="10000"} 0
prometheus_http_response_size_bytes_bucket{handler="/classic/status",le="100000"} 1
prometheus_http_response_size_bytes_bucket{handler="/classic/status",le="1e+06"} 1
prometheus_http_response_size_bytes_bucket{handler="/classic/status",le="1e+07"} 1
prometheus_http_response_size_bytes_bucket{handler="/classic/status",le="1e+08"} 1
prometheus_http_response_size_bytes_bucket{handler="/classic/status",le="1e+09"} 1
prometheus_http_response_size_bytes_bucket{handler="/classic/status",le="+Inf"} 1
prometheus_http_response_size_bytes_sum{handler="/classic/status"} 12335
prometheus_http_response_size_bytes_count{handler="/classic/status"} 1
...
prometheus_http_response_size_bytes_bucket{handler="/metrics",le="10000"} 24
prometheus_http_response_size_bytes_bucket{handler="/metrics",le="100000"} 25
prometheus_http_response_size_bytes_bucket{handler="/metrics",le="1e+06"} 25
prometheus_http_response_size_bytes_bucket{handler="/metrics",le="1e+07"} 25
prometheus_http_response_size_bytes_bucket{handler="/metrics",le="1e+08"} 25
prometheus_http_response_size_bytes_bucket{handler="/metrics",le="1e+09"} 25
prometheus_http_response_size_bytes_bucket{handler="/metrics",le="+Inf"} 25
prometheus_http_response_size_bytes_sum{handler="/metrics"} 201164
prometheus_http_response_size_bytes_count{handler="/metrics"} 25
...
prometheus_remote_storage_highest_timestamp_in_seconds 1.612091228e+09
...
prometheus_remote_storage_samples_in_total 8872
...
prometheus_target_interval_length_seconds_sum{interval="15s"} 345.00083064800003
prometheus_target_interval_length_seconds_count{interval="15s"} 23
...
prometheus_target_metadata_cache_bytes{scrape_job="prometheus"} 8865
...
prometheus_target_metadata_cache_entries{scrape_job="prometheus"} 153
...
prometheus_target_sync_length_seconds{scrape_job="prometheus",quantile="0.01"} 7.1868e-05
prometheus_target_sync_length_seconds{scrape_job="prometheus",quantile="0.05"} 7.1868e-05
prometheus_target_sync_length_seconds{scrape_job="prometheus",quantile="0.5"} 7.1868e-05
prometheus_target_sync_length_seconds{scrape_job="prometheus",quantile="0.9"} 7.1868e-05
prometheus_target_sync_length_seconds{scrape_job="prometheus",quantile="0.99"} 7.1868e-05
prometheus_target_sync_length_seconds_sum{scrape_job="prometheus"} 7.1868e-05
...
prometheus_tsdb_compactions_triggered_total 6
...
prometheus_tsdb_data_replay_duration_seconds 0.268290921
...
prometheus_tsdb_head_chunks 2202
...
prometheus_tsdb_head_chunks_created_total 2202
...
prometheus_tsdb_head_max_time 1.612091228689e+12
...
prometheus_tsdb_head_max_time_seconds 1.612091228e+09
...
prometheus_tsdb_head_min_time 1.6120872e+12
...
prometheus_tsdb_head_min_time_seconds 1.6120872e+09
# HELP prometheus_tsdb_head_samples_appended_total Total number of appended samples.
# TYPE prometheus_tsdb_head_samples_appended_total counter
prometheus_tsdb_head_samples_appended_total 8872
# HELP prometheus_tsdb_head_series Total number of series in the head block.
# TYPE prometheus_tsdb_head_series gauge
prometheus_tsdb_head_series 734
...
prometheus_tsdb_head_series_created_total 1072
...
prometheus_tsdb_head_series_removed_total 338
...
prometheus_tsdb_isolation_high_watermark 24
...
prometheus_tsdb_isolation_low_watermark 24
...
prometheus_tsdb_lowest_timestamp 1.611065243689e+12
...
prometheus_tsdb_lowest_timestamp_seconds 1.611065243e+09
...
prometheus_tsdb_storage_blocks_bytes 1.29008e+06
...
prometheus_tsdb_symbol_table_size_bytes 528
...
prometheus_tsdb_wal_completed_pages_total 1
...
prometheus_tsdb_wal_page_flushes_total 25
...
prometheus_tsdb_wal_segment_current 13

...
# 不删除data
alias dlv='gob && dlv exec ./prometheus --init .dbg/prometheus.dlv -- --config.file=documentation/examples/prometheus.yml'
# 删除data
...
0  0x0000000002a63dc9 in github.com/prometheus/prometheus/tsdb.(*headAppender).Append
   at ./tsdb/head.go:1206
1  0x0000000002a63013 in github.com/prometheus/prometheus/tsdb.(*initAppender).Append
   at ./tsdb/head.go:1084
2  0x0000000002a93908 in github.com/prometheus/prometheus/tsdb.(*dbAppender).Append
   at <autogenerated>:1
3  0x00000000029ad13f in github.com/prometheus/prometheus/storage.(*fanoutAppender).Append
   at ./storage/fanout.go:147
4  0x0000000002b6eafb in github.com/prometheus/prometheus/scrape.(*timeLimitAppender).Append
   at ./scrape/target.go:318
5  0x0000000002b6a108 in github.com/prometheus/prometheus/scrape.(*scrapeLoop).append
   at ./scrape/scrape.go:1342
6  0x0000000002b67865 in github.com/prometheus/prometheus/scrape.(*scrapeLoop).scrapeAndReport
   at ./scrape/scrape.go:1138
7  0x0000000002b667df in github.com/prometheus/prometheus/scrape.(*scrapeLoop).run
   at ./scrape/scrape.go:1039
